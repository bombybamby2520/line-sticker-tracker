...
MY_STICKERS = [
    ...
    {"id": "36729507", "name": "วีวี่ขอให้เป็นวันที่เริ่ด (Big)"},
    {"id": "36722787", "name": "วีวี่ขอให้เป็นวันที่เริ่ด"},
    {"id": "36700454", "name": "มาการองขอให้เป็นวันที่ดี (Big)"},
    {"id": "36710283", "name": "มาการองขอให้เป็นวันที่ดี"},
    ...
    {"id": "36474408", "name": "มินนี่ขออ้อนหน่อย (DukDik)"},
    {"id": "36365776", "name": "โยเกิร์ตแชททั้งวัน"},
    {"id": "36321152", "name": "มิวมิวขอให้เป็นวันที่ดี"},
    {"id": "36341425", "name": "มิวมิวขอให้เป็นวันที่ดี (Big)"},
    ...
    {"id": "36315462", "name": "มิลลิเห็นงานพี่เป็นลม (Big)"},
    {"id": "36315407", "name": "มิลลิเห็นงานพี่เป็นลม"},
